---
layout: post
title: "Carta aberta ao Presidente da Câmara Municipal do Porto – pela reformulação do Projeto para a Antiga Companhia Aurifícia"
...
![Extrato da Estrutura Ecológica do Porto salvaguardada no PDM]({{ site.baseurl }}/assets/images/aurificia-eeporto.gif)
*Extrato da Estrutura Ecológica do Porto salvaguardada no PDM e que seria largamente destruída segundo o projeto.*
...
![Fotografia aérea do local]({{ site.baseurl }}/assets/images/aurificia-foto-aerea.gif)
*Fotografia aérea do local: grande parte das manchas verdes seriam arrasadas com o atual projeto.*
